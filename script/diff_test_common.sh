...
run_diff_test() {
    ...
    local MAKEFILE_PATH=${3:-${ROOT}Makefile}  # custom makefile path
    ...
    local FT_LOG="${LOG_DIR}/${TARGET}_${TEST_TYPE}_ft.log"
    local STD_LOG="${LOG_DIR}/${TARGET}_${TEST_TYPE}_std.log"
    local DIFF_LOG="${LOG_DIR}/${TARGET}_${TEST_TYPE}_diff.log"
